...
public class JavaModelTest {
    ...
    public void arrayModelTest() {
        ...
        Assert.assertEquals(Sets.intersection(cm.imports, Sets.newHashSet("ApiModel", "List", "ArrayList", "Children")).size(), 3);
    }
    ...
    public void mapModelTest() {
        ...
        Assert.assertEquals(cm.imports.size(), 3);
        Assert.assertEquals(Sets.intersection(cm.imports, Sets.newHashSet("ApiModel", "Map", "HashMap", "Children")).size(), 3);
    }
