...
public class DefaultCodegen {
    ...
    public CodegenOperation fromOperation(String path,
        ...
        op.path = path;
        // replace text between {} with 1
        op.pathForDelegate = CharMatcher.inRange('{','}').removeFrom(StringUtils.replacePattern(path, "(?<=\\{)(.*?)(?=\\})", "1"));
        ...
        op.httpMethodCaps = httpMethod.toUpperCase();
